...
- articulos `a`, `an` y `the`;
- demostrativos y posesivos;
- como evitar errores tipicos de hispanohablantes.

---

## ¿Por qué importa para programadores?

Porque frases como estas dependen de estos elementos:
...
|---------|------|-------------|
| 01 | Pronombres personales | Sujeto y objeto: `I/me`, `he/him`, `they/them` |
| 02 | Artículos `a/an/the` | Cuándo usar cada uno y cuándo no usar ninguno |
| 03 | Demostrativos y posesivos | `this/that/these/those`, `my/your/its/their` |
| 04 | Ejercicios | Práctica integral |
...
- traducir posesivos de forma literal desde el español.
