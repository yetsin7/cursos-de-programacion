...
## Frases iconicas de la cultura tech
...
| "sudo make me a sandwich" | xkcd comic | Chiste sobre permisos de administrador |

---

## Debates eternos (Holy Wars)

Estos son debates que nunca terminan en la comunidad tech. Conocerlos es parte de la cultura.

### Tabs vs Spaces

```
// Team Tabs dice:
"Tabs are more accessible — users can set their own width."

// Team Spaces dice:
"Spaces ensure consistent formatting across all editors."
...
| Vim | Emacs |
|-----|-------|
| "Vim is lightweight and everywhere" | "Emacs is an operating system that lacks a good editor" |
| Modal editing (modes para insertar, navegar) | Everything is a keybinding |
| "How do I exit Vim?" es un meme | "Emacs pinky" (dolor por Ctrl) |

El chiste mas famoso: **"How do I exit Vim?"** tiene mas de 2 millones de visitas en Stack Overflow.

### Otras guerras santas

| Debate | Los dos lados |
|--------|---------------|
| **Dark mode vs Light mode** | "Dark mode saves battery and eyes" vs "Light mode is better for readability" |
| **Semicolons in JS** | "Always use semicolons" vs "Let the parser handle it" |
| **REST vs GraphQL** | "REST is simple and proven" vs "GraphQL solves over-fetching" |
| **Monolith vs Microservices** | "Monoliths are simpler" vs "Microservices scale better" |
| **SQL vs NoSQL** | "ACID compliance matters" vs "Schema flexibility rules" |
| **Linux vs Windows vs Mac** | Cada grupo cree que el suyo es superior |
| **Camel case vs Snake case** | `myVariable` vs `my_variable` |
...
| **Brogrammer** | Programador "bro culture" | Estereotipo negativo de Silicon Valley |
| **Code monkey** | Programador que solo ejecuta sin pensar | Puede ser despectivo |

### Frases que los programadores odian en ofertas de trabajo

```
"We're looking for a rockstar ninja developer who can 
wear many hats in our fast-paced environment. Must be 
passionate and willing to go the extra mile. We're like 
a family here."

Traduccion real: "Queremos una persona que haga el 
trabajo de tres por el salario de uno."
```
...
| Meme | Significado |
|------|-------------|
| **"Copying from Stack Overflow"** | La realidad de como muchos programadores resuelven problemas |
| **"It compiles! Ship it!"** | Que compile no significa que funcione bien |
| **"99 little bugs in the code, take one down, patch it around, 127 little bugs in the code"** | Arreglar un bug crea mas bugs |
...
| Comic | Tema | Leccion |
|-------|------|---------|
| "Is It Worth the Time?" | Automatizacion vs tiempo invertido | No todo vale la pena automatizar |
| "Standards" | Crear un nuevo estandar para unificar los existentes | Ahora hay N+1 estandares |
| "Compiling" | Excusa para no hacer nada: "my code is compiling" | Siempre hay una excusa |
| "Bobby Tables" | SQL injection con el nombre "Robert'; DROP TABLE Students;--" | Siempre sanitiza inputs |
...
| Indicador | Ejemplo |
|-----------|---------|
| **Comillas innecesarias** | "This 'simple' migration took us two weeks." |
| **Claramente exagerado** | "Oh great, another JavaScript framework." |
| **Tono opuesto al significado** | "I love debugging CSS at 2 AM." (no lo ama) |
...
|-------|-----------------|
| "That's a bold strategy." | Eso es una mala idea |
| "Interesting approach..." | Esto es raro/malo |
| "It's a feature, not a bug." | Es un bug pero no lo vamos a arreglar |
| "What could possibly go wrong?" | Muchas cosas pueden salir mal |
| "Famous last words." | Eso que dices va a resultar falso |
| "Sure, that'll scale." | No va a escalar |
| "That's one way to do it." | Hay mejores formas |
| "It's fine. Everything is fine." | Nada esta bien |
...
| Frase | Cuando se usa |
|-------|---------------|
| "Let's take a step back." | Antes de explicar el contexto |
| "Bear with me for a moment." | Pidiendo paciencia |
| "This is where it gets interesting." | Antes de la parte clave |
| "Here's where things went wrong." | Contando un postmortem |
| "Spoiler alert: it didn't work." | Anticipando un fracaso |
| "Any questions? No? Great, you're all experts now." | Humor al final |
| "As it turns out..." | Revelando algo inesperado |
| "Your mileage may vary." | Los resultados dependen del contexto |
...
| **Series A/B/C** | Rondas de financiacion |
| **Unicorn** | Startup valuada en mas de $1 billion |
| **Exit** | Venta de la empresa o IPO |
