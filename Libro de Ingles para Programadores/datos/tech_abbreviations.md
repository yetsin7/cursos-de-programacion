...
| **LSP** | Liskov Substitution Principle | Principio de sustitucion de Liskov |
| **ISP** | Interface Segregation Principle | Principio de segregacion de interfaces |
| **DIP** | Dependency Inversion Principle | Principio de inversion de dependencias |
| **DI** | Dependency Injection | Inyeccion de dependencias |
| **IoC** | Inversion of Control | Inversion de control |
...
| **CSRF** | Cross-Site Request Forgery | Falsificacion de solicitud entre sitios |
...
| **gRPC** | gRPC Remote Procedure Call | Llamada a procedimiento remoto gRPC |
| **GraphQL** | Graph Query Language | Lenguaje de consultas de grafos |
...
| Abreviacion | Significado completo | Espanol |
|-------------|---------------------|---------|
| **PR** | Pull Request | Solicitud de extraccion |
| **MR** | Merge Request (GitLab) | Solicitud de fusion |
...
| **TL;DR** | Too Long; Didn't Read | Muy largo; no lo lei (resumen) |
| **ETA** | Estimated Time of Arrival | Tiempo estimado de llegada |
| **EOD** | End of Day | Final del dia |
...
| **ACK** | Acknowledged | Recibido/entendido |
| **NACK** | Not Acknowledged | Rechazado |
