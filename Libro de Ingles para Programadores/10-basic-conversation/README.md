# Capítulo 10: Basic Conversation
...
| # | Archivo | Tema |
|---|---------|------|
| 01 | `01_greetings_and_introductions.md` | Saludos e introducciones |
| 02 | `02_daily_standup.md` | Cómo hablar en el daily standup |
| 03 | `03_asking_for_help.md` | Cómo pedir ayuda en inglés |
| 04 | `04_basic_slack_messages.md` | Mensajes de Slack y abreviaciones tech |
| 05 | `05_exercises.md` | Ejercicios de práctica del capítulo completo |
